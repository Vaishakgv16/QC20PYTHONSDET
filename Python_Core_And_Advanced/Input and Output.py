#input()
#Example 1
#Write a program to read employee data from the keyboard and display the info
'''
enum=input("Enter the employee Number")
...
age=27
sal=60475.02
print("Hello %s Your age is %i Your salary is %f"%(s,age,sal))
'''
